...
#define SEMA_C_UPTIME		0x00000001			///< Bit  0: Uptime & Pwr cycles counter
#define SEMA_C_RESTARTEVENT	0x00000002			///< Bit  1: System restart event
#define SEMA_C_1KB_FLASH	0x00000004			///< Bit  2: 1k USER flash memory available
#define SEMA_C_WATCHDOG		0x00000008			///< Bit  3: Watchdog
#define SEMA_C_TEMPERATURES	0x00000010			///< Bit  4: Temperature sensors installed/available
#define SEMA_C_VOLTAGES		0x00000020			///< Bit  5: Voltage sensors installed/available
#define SEMA_C_FAILREASON	0x00000040			///< Bit  6: Storage of failure reason available (exeption code)
#define SEMA_C_BL_TIMEOUT	0x00000080			///< Bit  7: Bootloader timeout programmable
#define SEMA_C_DISPLAYCTRL	0x00000100			///< Bit  8: Display control available
#define SEMA_C_PWRUP_WD		0x00000200			///< Bit  9: Power up watchdog available
#define SEMA_C_CURRENTS		0x00000400			///< Bit 10: Current sensors installed/available
#define SEMA_C_BOOTCOUNT	0x00000800			///< Bit 11: Bootcounter
#define SEMA_C_INPUTVOLT0	0x00001000			///< Bit 12: Input-Voltage0 V10:00=5V, 01=12V, 10+11=reserved
#define SEMA_C_INPUTVOLT1	0x00002000			///< Bit 13: Input-Voltage1 V10:00=5V, 01=12V, 10+11=reserved
#define SEMA_C_RSENSE		0x00004000			///< Bit 14: Rsense for Input-Voltage: 0=8mR, 1=4mR
#define SEMA_C_FAILSAFEBIOS	0x00008000			///< Bit 15: Fail-Safe-BIOS supported
#define SEMA_C_I2C1			0x00010000			///< Bit 16: Ext. I2C bus #1 available
#define SEMA_C_I2C2			0x00020000			///< Bit 17: Ext. I2C bus #2 available
#define SEMA_C_FAN_CPU		0x00040000			///< Bit 18: Programmable CPU fan available
#define SEMA_C_FAN_1		0x00080000			///< Bit 19: Programmable system fan available
#define SEMA_C_AT_ATX_MODE	0x00100000			///< Bit 20: AT/ATX mode supported
#define SEMA_C_THERMAL_SCI	0x00200000			///< Bit 21: Thermal SCI supported
#define SEMA_C_PWRLASTSTATE	0x00400000			///< Bit 22: Power up to last state
#define SEMA_C_BACKLGHTRES	0x00800000			///< Bit 23: Backlight restore
#define SEMA_C_DTS_REGISTER	0x01000000			///< Bit 24: DTS register
#define SEMA_C_DTS_OFFSET	0x02000000			///< Bit 25: DTS register offset
#define SEMA_C_FAN_2		0x04000000			///< Bit 26: Smart fan #3
#define SEMA_C_FAN_3		0x08000000			///< Bit 27: Smart fan #4
#define SEMA_C_GPIOS		0x10000000			///< Bit 28: TIVA GPIOs support (12GPIOs)
#define SEMA_C_I2C3		0x20000000			///< Bit 29: Ext. I2C bus #3 available
#define SEMA_C_I2C4		0x40000000			///< Bit 30: Ext. I2C bus #4 available
#define SEMA_C_BMC_TIVA		0x80000000			///< Bit 31: BMC is from TIVA type

#define SEMA_C_TEMPERATURES_1	0x00000001			///< Bit  0 : Extend Byte ( Bit 32 ): Temperature sensors 1 installed/available
#define SEMA_C_SMBUS_PEC	0x00000002			///< Bit  1 : Extend Byte ( Bit 33 ): SM-Bus PEC protocol
#define SEMA_C_AFU_EXIST	0x00000004			///< Bit  2 : Extend Byte ( Bit 34 ): This bit is reserved in BMC , SEMA use this bit to indentify what AFU exists or not
#define SEMA_C_ERROR_LOG	0x00000008			///< Bit  3 : Extend Byte ( Bit 35 ): Error log
#define SEMA_C_1WIRE		0x00000010			///< Bit  4 : Extend Byte ( Bit 36 ): 1-wire bus
#define SEMA_C_BMC_WAKE		0x00000020			///< Bit  5 : Extend Byte ( Bit 37 ): Wake by BMC
#define SEMA_C_GPIO_ADC		0x00000040			///< Bit  6 : Extend Byte ( Bit 38 ): GPIO with alternate function
#define SEMA_C_SOFT_FAN		0x00000080			///< Bit  7 : Extend Byte ( Bit 39 ): Software fan
