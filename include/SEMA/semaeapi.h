...
EApiStatus_t
SEMA_EAPI_CALLTYPE
SemaEApiGPIOPinGetConfig( __IN  uint32_t Handler, __IN uint8_t ID, __IN uint32_t *pConfiguration );

EApiStatus_t
SEMA_EAPI_CALLTYPE
SemaEApiGPIOPinGetADCValue( __IN  uint32_t Handler, __IN uint8_t ID, __IN uint32_t *pValue );
